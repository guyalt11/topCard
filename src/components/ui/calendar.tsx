  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-light-foreground rounded-md w-9 font-normal text-[0.8rem]",
        ...
        day_outside:
          "day-outside text-light-foreground opacity-50 aria-selected:bg-primary/50 aria-selected:text-light-foreground aria-selected:opacity-30",
        day_disabled: "text-light-foreground opacity-50",
        day_range_middle:
